...
#define DRAW_CONE(StartLocation, EndLocation, Color) if (GetWorld())\
{ \
	DrawDebugCone(GetWorld(), StartLocation, EndLocation, 100.f, FMath::DegreesToRadians(45.f), \
	FMath::DegreesToRadians(45.f), 6, Color, true); \
}
